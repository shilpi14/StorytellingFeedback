...
const SECTION_DEFS = [
  { key: "openingHook", title: "Opening and Hook" },
  { key: "bodyLanguageFacialExpressions", title: "Body Language and Facial Expressions" },
  { key: "voiceTonalityModulation", title: "Voice Tonality and Modulation" },
  { key: "narrativeStructureCoherence", title: "Narrative Structure and Coherence" },
  { key: "closingTakeaway", title: "Closing and Takeaway" }
];
 ...
 * five-category storytelling assessment (Opening and Hook / Body Language and
 * Facial Expressions / Voice Tonality and Modulation / Narrative Structure and
 * Coherence / Closing and Takeaway), each with its own short summary plus 0-3
 * coaching suggestions, an overall summary, and a closing priority focus —
 * assembled into the PDF's expected shape.
 */
